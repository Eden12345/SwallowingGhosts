        ...
        {view === 1 && (
          <ScrollView style={styles.scroller}>
            <Text style={styles.text}>
              {`\nThere were two tasks I had on my mind upon waking to another sunless sky; the first was to prove my sanity, and the second was to secure state funding for an interstellar voyage.\n\n
